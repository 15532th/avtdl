...
<!-- This file is autogenerated as part of avtdl at 2025-11-07 17:19:10.052786 -->
...
* `master_url`: link to the master playlist of the underlying HLS stream, inferred from the media_url when available. 
* `title`: space title. 
* `author`: user's visible name. 
* `username`: user's handle. 
* `avatar_url`: link to the picture used as the user's avatar. 
