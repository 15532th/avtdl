...
<!-- This file is autogenerated as part of avtdl 0.9.dev0+ga5c0e58.d20240216 at 2024-03-09 16:25:47.698860 -->
...
* `rename_suffix`: when overwriting is disabled, this suffix is attached to base filename with the "{i}" part replaced with a number. Must contain "{i}" exactly once. Default value is ` [{i}]`.
