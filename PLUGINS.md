...
<!-- This file is autogenerated as part of avtdl 0.9.dev0+ga8f3951.d20240131 at 2024-04-22 20:21:31.415160 -->
...
* [Filters:](#filters)
  ...
  * [filter.channel.notify - Hold upcoming streams records until the start time](#filterchannelnotify---hold-upcoming-streams-records-until-the-start-time)
* [Actions:](#actions)
...
### `filter.channel.notify` - Hold upcoming streams records until the start time
...
* `name`: name of a specific entity. Used to reference it in `chains` section. Must be unique within a plugin. Required.
##### 
* `prior`: output record this many minutes before the live start. Default value is `10`.
