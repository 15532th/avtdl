...
<!-- This file is autogenerated as part of avtdl at 2024-06-03 02:11:33.280402 -->
...
* `retweet`: Nested TwitterRecord containing tweet that was retweeted. 
* `quote`: Nested TwitterRecord containing tweet being quited. 
...
* `only_likes`: monitor tweets liked by user instead of the user's own tweets. Default value is `false`.
